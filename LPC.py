# -*- coding: utf-8 -*-
"""
Created on Sun Dec  8 23:23:31 2019
...
'''-------------------------------------RandomForest--------------------------------------'''
RF_clf=RandomForestClassifier(n_estimators=1000, max_features='auto', criterion='entropy', bootstrap=True,random_state=2)
start = time.time()
...
print('RandomForest识别准确率为：',(con_matrix[0,0]+con_matrix[1,1])/len(y_pred))
...
'''-----------------------------------------DecesionTree model----------------------------------'''
DT_clf = DecisionTreeClassifier(criterion='entropy',max_depth=50,min_samples_split=8,

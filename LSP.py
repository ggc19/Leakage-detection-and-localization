# -*- coding: utf-8 -*-
"""
Created on Sun Dec  8 23:38:03 2019
...
'''-------------------------------------RandomForest--------------------------------------'''
RF_clf=RandomForestClassifier(n_estimators=400, max_features='auto', criterion='entropy', bootstrap=True,random_state=2)
start = time.time()
